...
**Colors:**
- Primary: `orange` — buttons, links, key accents
- Secondary: `teal` — tags, highlights, secondary elements
...
- `/assessments` — Assessments dashboard (default view)
...
- `MainNav.tsx` — Top navigation component
...
- [ ] Shell renders with top navigation
