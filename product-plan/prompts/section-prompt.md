...
Copy and paste this prompt into your coding agent, filling in the variables at the top.
...
1. **Authentication & Authorization** (if not yet established)
   ...
   - Who can access the candidate view vs recruiter view?
...
4. **AI Integration** (for Assessments section)
   - How should the AI chat functionality work?
   - What model/service should generate questions and analyze responses?
